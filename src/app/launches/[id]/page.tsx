      ...
      <div className="max-w-6xl mx-auto px-6 py-6 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-5">
              ...
              {growthContrib !== 0 && (
                <div className="text-[10px] text-slate-500 bg-slate-50 rounded-lg px-2.5 py-2 mt-2">
                  This item accounts for ~{(growthContrib * 100).toFixed(1)}pp
                  of {launch.category}&apos;s growth
                </div>
              )}
            </div>
          ...
          <div className="space-y-5">
            ...
            {/* 5. Growth Contribution (conditional) */}
            {growthContrib !== 0 && (
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-3.5">
                ...
                <div className="text-2xl font-bold text-blue-600">
                  ~{(growthContrib * 100).toFixed(1)}pp
                </div>
                <div className="text-[10px] text-blue-500 mt-0.5">
                  of {launch.category} category&apos;s total growth
                </div>
              </div>
            )}
