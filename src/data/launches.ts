...
type RawLaunch = Omit<Launch, "innovationType">;
...
const SPECS: LaunchSpec[] = [
  ...
  { upc: "012345000010", description: "FitCore Protein Bar – Salted Caramel", brand: "FitCore", company: "Peak Performance Brands", category: "Bars", subcategory: "Protein Bars", daysAgoLaunched: 480, patternType: "winner", baseVelocity: 38, launchTdp: 780, priceLatest: 2.89, promoMix: 0.11, attributes: { form: "Bar", flavor: "Salted Caramel", packFormat: "Single", brandPositioning: "Performance", functionalIngredient: "Whey Protein", isOrganic: false, isNonGmo: true, isGlutenFree: true, isVegan: false, isKeto: false, isProteinFocused: true, healthFocus: "Muscle Recovery", eatingOccasion: "Post-Workout" } },
  ...
  { upc: "012345000015", description: "Harvest Gold Grain Bar – Oat & Honey", brand: "Harvest Gold", company: "WildRoots Co.", category: "Bars", subcategory: "Snack Bars", daysAgoLaunched: 430, patternType: "fader", baseVelocity: 8, launchTdp: 240, priceLatest: 1.99, promoMix: 0.40, attributes: { form: "Bar", flavor: "Oat Honey", packFormat: "Single", brandPositioning: "Value", functionalIngredient: null, isOrganic: false, isNonGmo: false, isGlutenFree: false, isVegan: false, isKeto: false, isProteinFocused: false, healthFocus: null, eatingOccasion: "Snacking" } },
  ...
  { upc: "023456000003", description: "VoltPure RTD Coffee – Oat Milk Latte", brand: "VoltPure", company: "Clarity Wellness", category: "Beverages", subcategory: "RTD Coffee", daysAgoLaunched: 450, patternType: "winner", baseVelocity: 35, launchTdp: 760, priceLatest: 4.99, promoMix: 0.12, attributes: { form: "Ready-to-Drink", flavor: "Caramel Oat Latte", packFormat: "Single", brandPositioning: "Premium", functionalIngredient: "Cold Brew Coffee", isOrganic: false, isNonGmo: true, isGlutenFree: true, isVegan: true, isKeto: false, isProteinFocused: false, healthFocus: "Energy", eatingOccasion: "Morning" } },
  ...
  { upc: "023456000011", description: "BrewCraft Cold Brew – Caramel Macchiato", brand: "BrewCraft", company: "WildRoots Co.", category: "Beverages", subcategory: "RTD Coffee", daysAgoLaunched: 540, patternType: "winner", baseVelocity: 33, launchTdp: 810, priceLatest: 4.99, promoMix: 0.11, attributes: { form: "Ready-to-Drink", flavor: "Caramel Macchiato", packFormat: "Single", brandPositioning: "Artisan", functionalIngredient: "Cold Brew Coffee", isOrganic: false, isNonGmo: true, isGlutenFree: true, isVegan: false, isKeto: false, isProteinFocused: false, healthFocus: "Energy", eatingOccasion: "Morning" } },
  ...
  // ─── SUPPLEMENTS ───────────────────────────────────────────────────────────
  { upc: "045678000001", description: "VitaGlow Gummies – Elderberry + Vitamin C", brand: "VitaGlow", company: "Clarity Wellness", category: "Supplements", subcategory: "Immune Support", daysAgoLaunched: 410, patternType: "winner", baseVelocity: 55, launchTdp: 720, priceLatest: 19.99, promoMix: 0.10, attributes: { form: "Gummies", flavor: "Elderberry", packFormat: "Single", brandPositioning: "Immune", functionalIngredient: "Elderberry + Vitamin C", isOrganic: false, isNonGmo: true, isGlutenFree: true, isVegan: true, isKeto: false, isProteinFocused: false, healthFocus: "Immune Support", eatingOccasion: "Daily" } },
  ...
  { upc: "045678000015", description: "CoQ10 Heart Health Capsules", brand: "OmegaPlus", company: "Clarity Wellness", category: "Supplements", subcategory: "Heart Health", daysAgoLaunched: 550, patternType: "fader", baseVelocity: 18, launchTdp: 310, priceLatest: 32.99, promoMix: 0.22, attributes: { form: "Capsules", flavor: "Unflavored", packFormat: "Single", brandPositioning: "Heart Health", functionalIngredient: "CoQ10", isOrganic: false, isNonGmo: false, isGlutenFree: true, isVegan: false, isKeto: false, isProteinFocused: false, healthFocus: "Heart Health", eatingOccasion: "Daily" } },
...
export const LAUNCHES: Launch[] = RAW_LAUNCHES.map((l) => ({
  ...l,
